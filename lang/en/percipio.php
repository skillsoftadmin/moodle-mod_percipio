...
$string['authenticationmethod_help'] = 'Select authentication method, OAuth or service account';
$string['clientid'] = 'Client id';
$string['scope'] = 'Scope';
$string['clientid_help'] = 'For method - OAuth: Enter client id.';
$string['scope_help'] = 'For method - OAuth: Enter scope.';
$string['clientsecret'] = 'Client secret';
$string['clientsecret_help'] = 'For method - OAuth: Enter client secret.';
$string['bearertoken'] = 'Bearer token';
$string['bearertoken_help'] = 'For method - service account: Enter Bearer token from percipio.';
$string['organizationid'] = 'Organization id';
$string['organizationid_help'] = 'Percipio organization id.';
$string['percipiourl'] = 'Percipio API URL';
$string['percipiourl_help'] = 'For method - service account: Enter Percipio API URL.';
$string['oauthurl'] = 'Percipio OAuth URL';
$string['oauthurl_help'] = 'For method - OAuth: Enter percipio OAuth URL.';
